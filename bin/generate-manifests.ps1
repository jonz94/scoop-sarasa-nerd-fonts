    ...
    $templateData = [ordered]@{
        ...
        "installer"     = @{
            "script" = @(
                ...
                '    Write-Host ""',
                '    Write-Host " Currently, on Windows 11 Version 22H2 (OS Build 22621) or later," -Foreground DarkCyan',
                '    Write-Host " font installation only works when installing font for all users." -Foreground DarkCyan',
                '    Write-Host ""',
